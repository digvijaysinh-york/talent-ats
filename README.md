...
Local **Talent Intelligence & Ranking** proof of concept: upload many résumés (PDF/DOCX) plus a job description, score with OpenAI, deduplicate by contact fields, and browse ranked results in the browser.
